    ...
    <div>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        <div className='my-5 rounded-md border border-richblack-700 bg-richblack-800 py-8 px-5 md:px-12'>
          <h1 className='text-lg mb-6 font-semibold text-richblack-5 uppercase tracking-wider'>
            Profile Information
          </h1>
          ...
          <div className='flex flex-col gap-y-6'>
            <div className='flex flex-col md:flex-row gap-5'>
              ...
              <label className='w-full' >
                <p className='label-style uppercase tracking-wider mb-1'>
            ...
            <div className='flex flex-col md:flex-row gap-5'>
              ...
              <label className='w-full' >
                <p className='label-style uppercase tracking-wider mb-1' >
                  Date of Birth <span className='text-pink-100'>*</span></p>
                <input
                  type='date'
                  name='dateOfBirth'
